        ...
        <div class="container">
            ...
            <div class="row gap-y">
                ...
                <div class="col-md-8 mx-auto">
                    <img src="images/dribbble-9.gif" alt="..." data-aos="fade-up" data-aos-duration="2000" class="aos-init">
                </div>
        ...
        <div class="container">
            ...
            <div class="row gap-y align-items-center">
                <div class="col-md-6 ml-auto">
                    ...
                    <p>As part of efforts to improve user onboarding, I shipped an experiment to a subset of new users showing them a Getting Started page immediately after signup to help them get to
                        what we think are some of the most important actions for new users to take. We compared the subset of users against a control group to see whether such an experience improved
                        engagement over a period of time.</p>
                </div>

                <div class="col-md-5 order-md-first">
                    <img class="rounded shadow-2" src="images/dribbble-6.png" alt="...">
                </div>
            </div>
            ...
            <div class="row gap-y align-items-center">
                <div class="col-md-6 mr-auto">
                    ...
                    <p>Last week we shipped outdated comments...well, brought them back, actually. We used to show collapsed comments on outdated diffs as a single line, but removed that when we
                        shipped code review recently. We brought that back last week with an improvement: you can now toggle open threads on outdated diffs in a review individually.</p>
                </div>

                <div class="col-md-5">
                    <img class="rounded shadow-2" src="images/dribbble-7.png" alt="...">
                </div>
            </div>
            ...
            <div class="row gap-y align-items-center">
                <div class="col-md-6 ml-auto">
                    ...
                    <p>Less an illustration, and more a literal proxy. These show up when the feature's introduced. Monotonectally leverage existing standards compliant ideas with distributed data.
                        Efficiently simplify cross-unit systems whereas adaptive testing. Monotonectally leverage existing standards compliant ideas with distributed data. Efficiently simplify
                        cross-unit systems whereas adaptive testing.</p>
                </div>

                <div class="col-md-5 order-md-first">
                    <img class="rounded shadow-2" src="images/dribbble-8.png" alt="...">
                </div>
            </div>
    ...
    <section id="section-pricing" class="section">
        <div class="container">
            <header class="section-header">
                ...
                <h2>Pricing</h2>
                <hr>
                <p class="lead">Choose any of the following plans to get start with. You can start with the FREE plan to see our web application at first. You can always change your plan from your
                    account.</p>
            </header>
            ...
            <div class="row gap-y text-center">
                ...
                <div class="col-md-4">
                    <div class="pricing-1">
                        ...
                        <div class="text-muted">
                            <small>1 Repository</small>
                            <br>
                            <small>1 Private Project</small>
                            <br>
                            <small>100 MB Attachment</small>
                            <br>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="pricing-1 popular">
                        ...
                        <div class="text-muted">
                            <small>1 Repository</small>
                            <br>
                            <small>10 Private Project</small>
                            <br>
                            <small>10 GB attachment</small>
                            <br>
                        </div>

                        <br>
                        <p class="text-center py-3">
                            <a class="btn btn-success" href="#monthly" data-bind-href="pricing" data-monthly="#monthly" data-yearly="#yearly">Get started</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="pricing-1">
                        ...
                        <div class="text-muted">
                            <small>5 Repository</small>
                            <br>
                            <small>25 Private Project</small>
                            <br>
                            <small>100 GB attachments</small>
                            <br>
                        </div>

                        <br>
                        <p class="text-center py-3">
                            <a class="btn btn-primary" href="#monthly" data-bind-href="pricing" data-monthly="#monthly" data-yearly="#yearly">Get started</a>
                        </p>
                    </div>
                </div>
